...
namespace QLBH_LeatherNotebooksShopApp.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,NameCate")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,NameCate")] Category category)
        {
            if (ModelState.IsValid)
            {
